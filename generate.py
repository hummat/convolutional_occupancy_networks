...
def main():
    ...
    for it, batch in enumerate(tqdm(test_loader, desc="Generating meshes:")):
        # Output folders
        ...
        if generate_mesh:
            ...
            if cfg['generation']['sliding_window']:
                ...
                out = generator.generate_mesh_sliding(batch)
            else:
        ...
        if generate_pointcloud:
            t0 = time.time()
            pointcloud = generator.generate_pointcloud(batch)
