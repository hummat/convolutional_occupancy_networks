...
python train_lightning.py "$CONFIG" --weights "$WEIGHTS" --early_stopping "$STOP" --visualize "$VISUALIZE" --num_workers "$WORKERS" --wandb --no_progress --prefetch_factor 1 --pin_memory
